...
<body class="well">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Editar Profesor - {{ $user->nombre . ' ' . $user->apellido }}</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-6">
				...
				{!! Form::open(['route' => ['HorseAnatomy.profesores.update', $user], 'method' => 'PUT', 'files' => true]) !!}
				...
				<div class="form-group">
					...
					{!! Form::select('rol', ['profesor' => 'Profesor'], $user->rol, ['class' => 'form-control', 'placeholder' => 'Seleccione Nivel De Usuario', 'required', 'id' => 'rol']) !!}
				</div>
