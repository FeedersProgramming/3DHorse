...
<body class="well">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Editar Administrador - {{ $user->nombre . ' ' . $user->apellido }}</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-6">
				...
				{!! Form::open(['route' => ['HorseAnatomy.administradores.update', $user], 'method' => 'PUT', 'files' => true]) !!}

				<div class="form-group">
					{!! Form::label('cedula', 'Cedula') !!}
					{!! Form::text('id', $user->id2, ['class' => 'form-control', 'placeholder' => 'Numero De Cedula', 'required', 'editable']) !!}
				</div>
				...
				<div class="form-group">
					...
					{!! Form::select('rol', ['administrador' => 'Administrador', 'profesor' => 'Profesor', 'estudiante' => 'Estudiante'], $user->rol, ['class' => 'form-control', 'placeholder' => 'Seleccione Nivel De Usuario', 'required', 'id' => 'rol']) !!}
				</div>
