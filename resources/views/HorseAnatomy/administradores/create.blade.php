...
<body class="well">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Registro Administrador</h3>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-6">
				...
				{!! Form::open(['route' => 'HorseAnatomy.administradores.store', 'method' => 'POST', 'files' => true]) !!}
				...
				<div class="form-group">
					...
					{!! Form::select('rol', ['administrador' => 'Administrador', 'profesor' => 'Profesor', 'estudiante' => 'Estudiante'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione Nivel De Usuario', 'required', 'id' => 'rol']) !!}
				</div>
