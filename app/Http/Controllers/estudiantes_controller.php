...
class estudiantes_controller extends Controller
{
    ...
    {
        $estudiantes = User::Search($request->nombre)->orderBy('id', 'ASC')->where('rol', 'estudiante')->paginate(12);
        return view('HorseAnatomy.estudiantes.estudiantes')->with('estudiantes', $estudiantes);
    }
    ...
    {
        return view('HorseAnatomy.estudiantes.create');
        dd('hola');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('HorseAnatomy.estudiantes.index');
    }
    ...
    public function edit($id)
    {
        ...
        $user->id2 = $user->id;
        //dd($user);   
        return view('HorseAnatomy.estudiantes.edit')->with('user', $user);
    }
